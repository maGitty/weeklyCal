...
\newcommand{\contacts}[1]{
  ...
  {\large Kontakte:}
  \vspace{6pt}
  \forloop{bulletct}{0}{\value{bulletct}<#1}{ \contactblock }
}
...
\forloop{repeater}{0}{\value{repeater}<3}{ \contacts{17} }

\forloop{repeater}{0}{\value{repeater}<5}{ \notes{44}{\textwidth} }
