...
%  \translate{\ifcase#1\or Januar\or Februar\or Maerz\or April\or Mai\or Juni\or Juli\or August\or September\or Oktober\or November\or Dezember\fi}%
%}
%
%\def\pgfcalendarweekdayshortname#1{%
%  \translate{\ifcase#1\or Mo\or Di\or Mi\or Do\or Fr\or Sa\or So \fi}%
%}
...
\newcommand{\birthdaypage}{
  ...
  \vspace{5pt}
  \begin{tabular}{|*4{p{\dimexpr0.23\textwidth-2\tabcolsep\relax}|}}
    \hline
    \textbf{Januar} &
    \textbf{Februar} &
    \textbf{Maerz} &
...
\newcommand{\showweek}[1]{
  ...
  \begin{tabular}{|*3{p{\dimexpr0.31\textwidth-2\tabcolsep\relax}|}}
    ...
    \AdvanceDate[3]\showdate &
    \cellcolor{accent_violet}
    \AdvanceDate[4]\showdate &
    \cellcolor{accent_blue}
    \AdvanceDate[5]\showdate
    \\\hline
    \showcell{\xwidth}{\cellrows} &
    \showcell{\xwidth}{\cellrows} &
    \showcell{\xwidth}{\cellrows}
...
\forloop[7]{daycounter}{0}{\value{daycounter}<365}{ \showweek{\calendarweek{\the\day}{\the\month}{\the\year}}\AdvanceDate[7] }
\AdvanceDate[-7]
